//! FIPS / Crypto Policy Command Module
//!
//! Extracted from commands/r9.rs — contains the executor factories
//! needed by the fips_crypto collector: create_fips_executor and
//! create_crypto_policy_executor.
