...
///
/// pub mod mount_point;
//  pub use mount_point::MountPointExecutor;
//
//////////////////////////////////////////////////////
...
pub struct MountPointExecutor {
    contract: CtnContract,
}

impl MountPointExecutor {
...
impl CtnExecutor for MountPointExecutor {
    fn execute_with_contract(
                ...
                for field in &state.fields {
                    ...
                    let actual_value = match data.get_field(&data_field_name) {
                        ...
                        None => {
                            ...
                            failure_messages
                                .push(format!("Mount point '{}': {}", object_id, msg));
                            continue;
                        }
                    };
        ...
        let message = if final_status == Outcome::Pass {
            format!(
                "Mount point validation passed: {} of {} mount points compliant",
                objects_passing,
                state_results.len()
            )
        } else {
