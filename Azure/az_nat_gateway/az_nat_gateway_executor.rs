...
pub struct AzNatGatewayExecutor {
    contract: CtnContract,
}

impl AzNatGatewayExecutor {
            ...
            for state in &criterion.states {
                if !state.record_checks.is_empty() {
                    if !resource_found {
                        ...
                        failure_messages.push(format!("NATGW '{}': {}", object_id, msg));
                        continue;
                    }
...
impl CtnExecutor for AzNatGatewayExecutor {
