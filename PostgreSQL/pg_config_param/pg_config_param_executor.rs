//! PostgreSQL Configuration Parameter Executor
...
//  pub use pg_config_param::PgConfigParamExecutor;
//
//////////////////////////////////////////////////////
...
pub struct PgConfigParamExecutor {
    contract: CtnContract,
}

impl PgConfigParamExecutor {
...
impl CtnExecutor for PgConfigParamExecutor {
    fn execute_with_contract(
        ...
        let message = if final_status == Outcome::Pass {
            format!(
                "PostgreSQL config parameter validation passed: {} of {} parameters compliant",
                objects_passing,
                state_results.len()
            )
        } else {
            format!(
                "PostgreSQL config parameter validation failed:\n  - {}",
